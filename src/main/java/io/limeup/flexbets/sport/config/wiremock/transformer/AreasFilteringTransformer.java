...
@Slf4j
public class AreasFilteringTransformer extends BaseFilteringTransformer {
    @Override
    public String getName() {
        return "areas-filtering-transformer";
    }
    ...
    protected Map<String, List<String>> extractFilters(LoggedRequest request) {
        ...
        filters.put("id", extractListQueryParam(request, "area_ids"));
        return filters;
    }
